...
type
  ...
  public
    ...
    /// <summary>
    /// The updateСs unique identifier. Update identifiers start from a certain
    /// positive number and increase sequentially. This ID becomes especially handy if
    /// youТre using Webhooks, since it allows you to ignore repeated updates or to
    ...
    /// <summary>Optional. New incoming message of any kind Ч text, photo, sticker, etc.
    /// </summary>
    ...
    /// <summary>Optional. New incoming channel post of any kind Ч text, photo, sticker,
    /// etc.
    /// </summary>
...
begin
  case GetTypeKind(T) of
    tkClass:
      PObject(@FResult).Free; // DONE -o@rareMax -cMemLeack: ѕроверить, рабочий ли это способ очистки пам€ти
  end;
  inherited Destroy;
end;
